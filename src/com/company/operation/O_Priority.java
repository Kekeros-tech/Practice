...
public class O_Priority implements IOperation {
    ...
    public O_Priority() {
        underlyingOperation = new O_Basic();
    }

    public O_Priority(IOperation operation) {
        underlyingOperation = operation;
    }

    public O_Priority(Series serialAffiliation,
                      Group resourceGroup,
                      Duration durationOfExecution,
                      int currentOperationMode){
        underlyingOperation = new O_Basic(serialAffiliation, resourceGroup, durationOfExecution, currentOperationMode);
    }
